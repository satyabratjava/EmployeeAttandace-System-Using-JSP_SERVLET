...
/**
 * Servlet implementation class SearchByDeptLoc
 */
@WebServlet("/SearchByDeptLoc")
public class SearchByDeptLoc extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchByDeptLoc() {
        super();
		...
		response.setContentType("text/html");
		 pw.print("<table width='100%' border='1' >");
		  ...
		  Connection con=DbCon.GetConnection();
			...
			String sql=" select emp_no,emp_name,dept_name,emp_sex,emp_hiredate,emp_job,emp_salary,emp_mail, dept_loc from emp,dept where emp.dept_no=dept.dept_no and dept_loc=?";
			try {
