...
/**
 * Servlet implementation class SearchByEmpJob
 */
@WebServlet("/SearchByEmpJob")
public class SearchByEmpJob extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchByEmpJob() {
        super();
		...
		response.setContentType("text/html");
		 ptr.print("<table width='100%' border='1' >");
		  ...
		  Connection con=DbCon.GetConnection();
			String sql=" select * from emp where emp_job=?";
			try {
				PreparedStatement pst=con.prepareStatement(sql);
				pst.setString(1, empjob);
